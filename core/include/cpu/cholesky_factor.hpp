...
/**
 * @brief Performs future free synchronous right-looking tiled Cholesky decomposition.
 *
 ...
 * @param n_tiles Number of tiles per dimension.
 */
void right_looking_cholesky_tiled_loop(std::vector<std::vector<double>> &ft_tiles, int N, std::size_t n_tiles);
